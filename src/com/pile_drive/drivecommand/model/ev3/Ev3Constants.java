...
public interface Ev3Constants {
	...
	public static byte INPUT_READ = (byte) 0x9A;	// Percent Value (Returns at least 1 byte)
	public static byte INPUT_TEST = (byte) 0x9B;
	public static byte INPUT_READY = (byte) 0x9C;
	public static byte INPUT_READSI = (byte) 0x9D;	// SI Value (Returns at least 4 bytes)
